      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div className="space-y-1">
            ...
            <p className="text-slate-400 text-sm">
              Gestiona tickets de soporte y atención al cliente.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          {[
            ...
            <Card
              key={stat.label}
              className="bg-slate-900/40 border-white/5 backdrop-blur-xl"
            >
        ...
        <Card className="bg-slate-900/40 border-white/5 backdrop-blur-xl rounded-3xl overflow-hidden">
          <CardHeader className="border-b border-white/5">
            ...
            <CardDescription>
              Lista detallada de las solicitudes de soporte.
            </CardDescription>
          </CardHeader>
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-white/5 bg-white/5">
                    ...
                    <th className="p-4 text-xs font-black uppercase tracking-widest text-slate-500 text-right">
                      Acción
                    </th>
                  </tr>
                </thead>
                    ...
                    tickets.map((ticket) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <Badge
                            variant="outline"
                            className={`text-[10px] uppercase font-black tracking-widest ${statusColors[ticket.status]}`}
                          >
                            {ticket.status}
                          </Badge>
                        </td>
                        <td className="p-4">
                          <Badge
                            variant="secondary"
                            className={`text-[9px] uppercase font-black tracking-widest ${priorityColors[ticket.priority]}`}
                          >
                            {ticket.priority}
                          </Badge>
                        </td>
