...
const mockProjects: Project[] = [
  {
    ...
    description: 'Lanzamiento de nuevos productos',
    status: 'active',
    progress: 65,
    dueDate: '2026-03-31',
    priority: 'high',
  ...
  },
  {
    id: 2,
    name: 'Rediseno Web',
    description: 'Modernizacion del sitio corporativo',
    status: 'planning',
    progress: 15,
    dueDate: '2026-02-28',
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'Conectar sistemas de ventas',
    status: 'active',
    progress: 80,
    dueDate: '2026-01-30',
    priority: 'high',
  ...
  {
    id: 4,
    name: 'Automatizacion Marketing',
    description: 'Flujos automaticos de email',
    status: 'completed',
    progress: 100,
    dueDate: '2025-12-15',
    priority: 'medium',
            ...
            >
              <CardContent className="p-5 space-y-4">
                <div className="flex items-start justify-between">
                  ...
                  <Badge
                    className={`${statusColors[project.status]} border uppercase text-[9px] font-black`}
                  >
                    {project.status}
                  </Badge>
                </div>
