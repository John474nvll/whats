  ...
  return (
    <div className="p-8 max-w-6xl mx-auto space-y-8">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-4xl font-black tracking-tighter text-cyan-neon">
            Links Tracking
          </h1>
          <p className="text-muted-foreground font-medium">
            Mide el impacto de tus publicaciones.
          </p>
        </div>
        <Button
          onClick={() => {
      ...
      <div className="space-y-4">
        {links?.map((link) => (
          <Card
            key={link.id}
            className="glass-card flex items-center p-6 gap-6"
          >
            ...
            <div className="text-center px-8 border-x border-border/50">
              <p className="text-2xl font-black text-cyan-neon">
                {link.clicks}
              </p>
