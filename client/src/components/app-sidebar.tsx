...
export function AppSidebar() {
  ...
  return (
    <Sidebar className="bg-slate-950/95 backdrop-blur-3xl border-r border-white/5 shadow-[20px_0_50px_rgba(0,0,0,0.5)] group/sidebar data-[state=collapsed]:w-[var(--sidebar-width-icon)]">
      <SidebarContent className="space-y-1 md:space-y-2 pt-4">
        {/* Logo Section removed since it's in Header */}
